    ...
    ({ className, variant = 'primary', size = 'md', ...props }, ref) => {
        ...
        return (
            <button
                ref={ref}
                className={cn(
                    'inline-flex items-center justify-center rounded-md font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-stone-400 disabled:pointer-events-none disabled:opacity-50 tracking-wide',
                    variants[variant],
                    sizes[size],
                    className
                )}
